...
def promote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user_member.status == 'administrator' or user_member.status == 'creator':
        message.reply_text("Do you want me to give him a second star🌟?")
        return ""
    ...
    message.reply_text("Here take your one star🌟!You are now an admin 😉")
    return "<b>{}:</b>" \
           "\n#PROMOTED" \
           "\n<b>Admin:</b> {}" \
...
def demote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user_member.status == 'creator':
        message.reply_text("i can't ban creator of the group!Sorry.... 😬")
        return ""

    if not user_member.status == 'administrator':
        message.reply_text("Can't demote when he didn't get one star 💫!")
        return ""
